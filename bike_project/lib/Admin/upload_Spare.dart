...
class Spare_Upload extends StatefulWidget {
  const Spare_Upload({super.key});

  @override
  State<Spare_Upload> createState() => _Spare_UploadState();
}

class _Spare_UploadState extends State<Spare_Upload> {
 String itemPrice = "";
  ...
  Future<void> _selectAndUploadImage() async {
    ...
    if (pickedImage != null) {
      ...
      newDocumentId =
          FirebaseFirestore.instance.collection('Spare').doc().id;
