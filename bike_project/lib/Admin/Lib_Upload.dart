...
class Cafe_Item extends StatefulWidget {
  const Cafe_Item({super.key});

  @override
  State<Cafe_Item> createState() => _Cafe_ItemState();
}

class _Cafe_ItemState extends State<Cafe_Item> {
  String itemPrice = "";
  String _selectedCategory = "Frame Part";
  ...
  Future<void> _selectAndUploadImage() async {
    ...
    if (pickedImage != null) {
      ...
      newDocumentId =
          FirebaseFirestore.instance.collection('Parts_Items').doc().id;

      // Upload the image to Firebase Storage
      final storageRef = FirebaseStorage.instance.ref().child(
          'images/${newDocumentId}_${_selectedCategory}.jpg');
                    ...
                    if (itemName.isEmpty || itemPrice.isEmpty) {
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            content:
                                Text("Item and Price cannot be empty."),
                            actions: [
                              TextButton(
                                onPressed: () {
